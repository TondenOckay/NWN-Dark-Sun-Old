...
void h2_InitHungerThirstCheck(object oPC)
{
    ...
    int timerID = h2_CreateTimer(oPC, H2_HT_TIMER_SCRIPT, HoursToSeconds(1));
...
void h2_DisplayHTInfoBars(object oPC)
{
    ...
    string greenBar = h2_ColorText(GetSubString(H2_HT_INFO_BAR, 0, hungerCount), 0, 255, 0);
    string redBar = h2_ColorText(GetSubString(H2_HT_INFO_BAR, hungerCount, 100 -  hungerCount), 255, 0, 0);
    SendMessageToPC(oPC, H2_TEXT_HUNGER + greenBar + redBar);
    greenBar = h2_ColorText(GetSubString(H2_HT_INFO_BAR, 0, thirstCount), 0, 255, 0);
    redBar = h2_ColorText(GetSubString(H2_HT_INFO_BAR, thirstCount, 100 - thirstCount), 255, 0, 0);
...
void h2_PerformHungerThirstCheck(object oPC)
{
