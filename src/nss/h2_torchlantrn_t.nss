/*
Filename:           h2_torchlantrn_t
System:             torches and lanterns
Author:             Edward Beck (0100010)
Date Created:       Aug. 30, 2006
Summary:
HCR2 h2_torchlantrn_t text script.
This is a text script for the torches and lanterns subsystem.
...
const string H2_TEXT_OIL_FLASK_FAIED_TO_IGNITE = "The oil flask failed to ignite.";
