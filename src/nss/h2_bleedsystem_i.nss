/*
Filename:           h2_bleedsystem_i
System:             bleed system (include script)
Author:             Edward Beck (0100010)
Date Created:       Oct. 15, 2005
Summary:
HCR2 h2_playerdying system function definition file.
This script is consumed by the h2_bleedtimer script as an include file.
...
Made code adjustments to handle type change of bleed and stable delay values.
Fixed bug where HP of last bleed check was not being tracked.
*/

#include "h2_core_i"
#include "h2_bleedsystem_c"
