/*
Filename:           h2_bleedsystem_t
System:             bleedsystem (text include script)
Author:             Edward Beck (0100010)
Date Created:       Aug. 30, 2006
Summary:
HCR2 String constants
This file holds the various strings associated with the HCR2 bleed subsystem

To make an alternate language version of this script, save this script with a different name,
and translate all of the below text. Then in h2_bleedsystem_c, replace [#include "h2_bleedsystem_t"]
